...
wget -N -q --show-progress -O $script "https://raw.githubusercontent.com/bjaudon/retroflag-picase/master/SafeShutdown_gpi.py"
wget -N -q --show-progress "https://raw.githubusercontent.com/bjaudon/retroflag-picase/master/multi_switch.sh"
